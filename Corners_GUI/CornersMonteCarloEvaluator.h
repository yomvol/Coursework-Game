...
public:
	CornersMonteCarloEvaluator(CornersBoardModel* board, int numIterations, Tile StartTurn, unsigned int startcol, unsigned int startrow, unsigned int endcol, unsigned int endrow, unsigned int NumWhiteTurns, unsigned int NumBlackTurns);
